...
class TestMessageCodes:
    async def test_accept_language_en(self) -> None:
        ...
        assert (
            response_message
            == MessageCodes.english_message_names[MessageCodes.successful_operation]
        )
    ...
    async def test_accept_language_fa(self) -> None:
        ...
        assert (
            response_message
            == MessageCodes.persian_message_names[MessageCodes.input_error]
        )
    ...
    async def test_accept_language_default(self) -> None:
        ...
        assert (
            response_message
            == MessageCodes.persian_message_names[MessageCodes.not_found]
        )
